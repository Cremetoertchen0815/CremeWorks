...
partial class PlaylistEditor
{
    ...
    private void InitializeComponent()
    {
        ...
        btnCopy.Font = new Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point, 0);
        btnCopy.Location = new Point(443, 6);
        btnCopy.Margin = new Padding(4);
        btnCopy.Name = "btnCopy";
        btnCopy.Size = new Size(32, 23);
        btnCopy.TabIndex = 27;
        btnCopy.Text = "CC";
        ...
        boxSelector.Size = new Size(340, 23);
        ...
        btnPlus.Location = new Point(413, 6);
        ...
        MaximumSize = new Size(535, 3998);
        MinimumSize = new Size(535, 418);
        Name = "PlaylistEditor";
        Text = "Playlists";
