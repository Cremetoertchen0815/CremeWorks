...
namespace CremeWorks
{
    public partial class APEditor : Form
    {
        ...
        public APEditor(IDataParent parent, Song s, int id)
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e) { return; } //=> SendSystemBulkdumpRequest(_d.Output, _refaceDat?.DeviceType ?? RefaceType.Undefined);
