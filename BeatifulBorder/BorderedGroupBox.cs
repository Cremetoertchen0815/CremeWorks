    ...
    public class BorderedGroupBox : GroupBox
    {
        ...
        private void DrawGroupBox(Graphics g)
        {
            ...
            Rectangle rect = new Rectangle(this.ClientRectangle.X,
                                            ...
                                            this.ClientRectangle.Width - this._borderWidth,
            ...
            GraphicsExtension.GenerateRoundedRectangle(g, borderPen, new RectangleF(rectX, rect.Y, rect.Width, rectHeight), (float)this._borderRadius);
